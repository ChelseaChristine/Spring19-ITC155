...
public class IntTree {
    ...
    //here is my countEmpty solution
    public int countEmpty() {
        return countEmpty(overallRoot);
    }
    // this will run through the root and either return 1 if there is nothing, or return the overall right of the right and left if there is something
